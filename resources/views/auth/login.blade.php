...
<head><script src="{{asset('vendor/bootstrap2/js/color-modes.js')}}"></script>
    ...
    <title>Signin · AREA 25, VICTORY TEMPLE </title>
    ...
    <link rel="stylesheet" href="{{asset('vendor/bootstrap2/sign-in/sign-in.css')}}">
</head>
...
<main class="form-signin w-100 m-auto">
    <form method="POST" action="{{ route('login') }}">
        ...
        <h2 style="margin-left: 10% !important;" class="h3 mb-3 fw-normal">EAGLES CATHEDRAL</h2>
        @csrf
