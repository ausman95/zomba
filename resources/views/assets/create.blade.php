                    ...
                    <form action="{{ route('assets.store') }}" method="POST" autocomplete="off">
                        ...
                        <input type="hidden" name="updated_by" value="{{ request()->user()->id }}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <!-- Bank Field -->
                                <div  id="banks_field" style="display: none;">
                                    <div class="form-group">
                                ...
                                <!-- Suppliers Field -->
                                <div  id="suppliers_field" style="display: none;">
                                    <div class="form-group">
                                        <label for="creditor_id">Supplier/Creditor <span class="text-danger">*</span></label>
                                        <select name="creditor_id" id="creditor_id" class="select-relation form-select @error('creditor_id') is-invalid @enderror" style="width: 100%">
                                ...
                                <!-- Cheque Number Field -->
                                <div  id="cheque_number_field" style="display: none;">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="creditor_id">Account <span class="text-danger">*</span></label>
                                    <select name="account_id" id="account_id" class="select-relation form-select @error('account_id') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="life" required class="form-control @error('life') is-invalid @enderror" value="{{ old('life') }}" placeholder="Asset Life span">
                                    @error('life')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-block mt-3">Save Asset</button>
                    </form>
                </div>
            </div>
        </div>
