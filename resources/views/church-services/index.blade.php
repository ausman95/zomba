        ...
        <div class="mt-3">
            @if(request()->user()->designation=='administrator')
                <a href="{{route('services.create')}}" class="btn btn-primary btn-md rounded-0">
                    <i class="fa fa-user-plus"></i>New Service
                </a>
            @endif
            <div class="mt-3">
                <div class="row">
                    <div class="col-sm-12 mb-2 col-md-12 col-lg-12">
                        <div class="card " style="min-height: 30em;">
                            <div class="card-body px-1">
                                @if($services->count() === 0)
                                    <i class="fa fa-info-circle"></i>There are no Service!
                                @else
                                    <div style="overflow-x:auto;">
                                        <table class="table  table-bordered table-hover table-striped">
                                            <caption style=" caption-side: top; text-align: center">SERVICES</caption>
                                            <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>NAME</th>
