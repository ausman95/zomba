...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        ...
        <p>
            Manage Division Section Transaction
        </p>
        <nav>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tr>
                                        <td>Section</td>
                                        <td>{{@$transaction->section->name.' '.@$transaction->section->district->name.' District'}}</td>
                                    </tr>
                                    <tr>
                                        <td>Payment For</td>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <a href="{{route('section.generate')."?id=".$transaction->id}}"
...
{{--                                        <div class="">--}}
{{--                                            <form action="{{route('member-transactions.destroy',$transaction->id)}}" method="POST" id="delete-form">--}}
{{--                                                @csrf--}}
