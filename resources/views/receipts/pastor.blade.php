...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        ...
        <p>
            Manage Division Member Transaction
        </p>
        <nav>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tr>
                                        <td>Member</td>
                                        <td>{{@$transaction->member->name.' of '.@$transaction->member->church->name.' Church'}}</td>
                                    </tr>
                                    <tr>
                                        <td>Payment For</td>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <a href="{{route('pastor.generate')."?id=".$transaction->id}}"
