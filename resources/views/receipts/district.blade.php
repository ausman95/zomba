...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        ...
        <p>
            Manage Division District Transaction
        </p>
        <nav>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tr>
                                        <td>District</td>
                                        <td>{{@$transaction->district->name.' '.@$transaction->division->name.' Division'}}</td>
                                    </tr>
                                    <tr>
                                        <td>Payment For</td>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <a href="{{route('district.generate')."?id=".$transaction->id}}"
                                    ...
                                    @if(request()->user()->desgination!='clerk')
                                        <div class="">
                                            <form action="{{route('district-transactions.destroy',$transaction->id)}}" method="POST" id="delete-form">
                                                @csrf
