    ...
    <div class="container-fluid ps-1 pt-4">
        ...
        <div class="mt-3">
            @if(request()->user()->designation=='administrator')
                <a href="{{route('ministries.create')}}" class="btn btn-primary btn-md rounded-0">
                    <i class="fa fa-plus-circle"></i>New Ministry
                </a>
            @endif
            <div class="mt-3">
                <div class="row">
                        ...
                        <div class="card " style="min-height: 30em;">
                            <div class="card-body px-1">
                                @if($ministries->count() === 0)
                                    <i class="fa fa-info-circle"></i>There are no Ministries!
                                @else
                                    <div style="overflow-x:auto;">
                                        <table class="table  table-bordered table-hover table-striped">
                                            <caption style=" caption-side: top; text-align: center">MINISTRIES</caption>
                                            <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>NAME</th>
