...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        <h4>
            <i class="fas fa-user-plus"></i> Create Debtor
        </h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Debtor</li>
            </ol>
        </nav>
        <hr>
        <div class="mt-2">
            <div class="row">
                <div class="col-sm-12 col-md-8 col-lg-6">
                    <form action="{{ route('debtors.store') }}" method="POST" autocomplete="off">
                        @csrf
