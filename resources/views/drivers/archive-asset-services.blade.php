...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        <h4>
            <i class="fa fa-car"></i> Archive Asset Services
        </h4>
        <p>
            Archive Asset Services
        </p>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Archive Asset Services</li>
            </ol>
        </nav>
        <div class="mb-5">
            <hr>
                ...
                <div class="col-sm-12 mb-2 col-md-12 col-lg-12">
                    <div class="card " style="min-height: 30em;">
                        <div class="card-body px-1">
                            @if($services->count() === 0)
                                <i class="fa fa-info-circle"></i>There are no Archive Asset Services Asset Services!
                            @else
                                <div style="overflow-x:auto;">
                                    <table class="table table-primary table-bordered table-hover table-striped" id="data-table">
                                        <caption style=" caption-side: top; text-align: center">ARCHIVE ASSET SERVICES</caption>
                                        <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>ASSETS</th>
                                        ...
                                        @foreach($services as $service)
                                            @if($service->getDaysRemainingAttribute()<=0)
                                                <tr>
                                                    <td>{{$c++}}</td>
