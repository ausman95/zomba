...
@section('content')
    <div class="container-fluid ps-1 pt-4">
        ...
        <p>
            Manage Home Churches Transactions
        </p>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
                <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('payments.index')}}">payments</a></li>
                <li class="breadcrumb-item active" aria-current="page">Home Church Transactions</li>
            </ol>
        </nav>
        <div class="mb-5">
            <hr>
                                ...
                                @else
                                    <div style="overflow-x:auto;">
                                        <table class="table  table-bordered table-hover table-striped">
                                            <caption style=" caption-side: top; text-align: center">HOME CHURCH TRANSACTIONS</caption>
                                            <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th>DATE</th>
                                        ...
                                        @foreach($payments as $payment)
                                            <tr>
                                                ...
                                                <td>{{$payment->getHome($payment->id) }}</td>
                                                ...
                                                <td>
                                                    <a href="{{route('church-receipt.generate')."?id={$payment->id}"}}" target="_blank" class="btn btn-primary rounded-0" style="margin: 2px">
