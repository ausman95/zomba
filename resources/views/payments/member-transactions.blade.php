                                    ...
                                    <div style="overflow-x:auto;">
                                        ...
                                        @foreach($payments as $payment)
                                            <tr>
                                                ...
                                                <td>{{$payment->getMember($payment->id) }}</td>
                                                <td>{{number_format($payment->amount) }}</td>
                                                <td>{{ucwords($payment->account->name) }}</td>
                                                <td>{{$payment->getMemberHome($payment->id) }}</td>
                                                <td>{{$payment->getMemberMinistry($payment->id) }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{route('receipt.generate')."?id={$payment->id}"}}" target="_blank" class="btn btn-primary rounded-0" style="margin: 2px">
