...
class CreateCreditorStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('creditor_statements', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('creditor_statements');
    }
}
